...
StaticButton.prototype.display = function(){
    ...
    if (this.texture.display && !this.disabled) ctx.drawImage(texture,this.texture.x+(this.active&&this.texture.oX?this.texture.oX:0),this.texture.y+(this.active&&this.texture.oY?this.texture.oY:0),this.texture.width,this.texture.height,0,0,this.width,this.height);
...
StaticButton.prototype.onClick = function(e){
    if (!this.disabled) eval(this.func);
}